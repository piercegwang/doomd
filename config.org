...
(map! (:map evil-org-agenda-mode-map
         :localleader
         :desc "Agenda Log Mode" "l" #'org-agenda-log-mode))
#+end_src
...
#+begin_src emacs-lisp
(map! :map evil-org-agenda-mode-map
      :localleader :n "m m l" #'org-agenda-log-mode
      :localleader :n "m m r" #'pgw/org-agenda-reload-files
      :localleader :n "f s" #'org-save-all-org-buffers)
#+end_src
...
(use-package! org-ai
  :config
  (setq org-ai-openai-api-token pgw/openai-key
        org-ai-default-chat-model "gpt-3.5-turbo-1106"))
#+end_src
