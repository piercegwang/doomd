...
(setq doom-unicode-font (font-spec :family "Noto Serif SC")
...
#+begin_src emacs-lisp
(add-to-list 'load-path (expand-file-name "~/.doom.d/custom/"))
#+end_src
...
(map! :map evil-org-agenda-mode-map
      :leader "m m l" #'org-agenda-log-mode
      :leader "m m r" 'pgw/org-agenda-reload-files)
#+end_src
...
(personal
 (setq org-capture-templates
       (doct '(("Inboxes" :keys "i"
               ...
               ("Columbia" :keys "c"
                :type entry
                :children (("STATUN1001_001_2022_3 - INTRO TO STATISTICAL REASONING" :keys "s"
                            :file "~/NextCloud/Documents/org-roam/20220902082826-columbia_fall_2022_classes_assignments.org"
                            :regexp "INTRO TO STATISTICAL REASONING"
                            :template ("* NEXT %?"
                                       "DEADLINE: %^T"))
                           ("HUMAUN1123_027_2022_3 - MASTERPIECES OF WESTERN MUSIC" :keys "m"
                            :file "~/NextCloud/Documents/org-roam/20220902082826-columbia_fall_2022_classes_assignments.org"
                            :regexp "MASTERPIECES OF WESTERN MUSIC"
                            :template ("* NEXT %?"
                                       "DEADLINE: %^T"))
                           ("CSEEW3827_001_2022_3 - FUNDAMENTALS OF COMPUTER SYSTSM" :keys "c"
                            :file "~/NextCloud/Documents/org-roam/20220902082826-columbia_fall_2022_classes_assignments.org"
                            :regexp "FUNDAMENTALS OF COMPUTER SYSTSM"
                            :template ("* NEXT %?"
                                       "DEADLINE: %^T"))
                           ("COMSW3261_002_2022_3 - COMPUTER SCIENCE THEORY" :keys "t"
                            :file "~/NextCloud/Documents/org-roam/20220902082826-columbia_fall_2022_classes_assignments.org"
                            :regexp "COMPUTER SCIENCE THEORY"
                            :template ("* NEXT %?"
                                       "DEADLINE: %^T"))
                           ("COCICC1101_021_2022_3 - CONTEMP WESTERN CIVILIZATION I" :keys "p"
                            :file "~/NextCloud/Documents/org-roam/20220902082826-columbia_fall_2022_classes_assignments.org"
                            :regexp "CONTEMP WESTERN CIVILIZATION I"
                            :template ("* NEXT %?"
                                       "DEADLINE: %^T"))
                           ("CHNSUN2201_002_2022_3 - SECOND YEAR CHINESE I" :keys "C"
                            :file "~/NextCloud/Documents/org-roam/20220902082826-columbia_fall_2022_classes_assignments.org"
                            :regexp "SECOND YEAR CHINESE I"
                            :template ("* NEXT %?"
                                       "DEADLINE: %^T"))))
...
(personal
 ...
 (setq org-publish-project-alist
       '(("pages-notes"
          ...
          :base-extension "org"
          :publishing-directory "~/Documents/github/piercegwang.github.io/"
          :recursive t
...
#+begin_src emacs-lisp
(personal (setq pgw/refile-targets (file-expand-wildcards "~/NextCloud/Documents/org-roam/*.org")))
#+end_src
*** Org Refile:
#+begin_src emacs-lisp
...

=A1oQ
-----END PGP MESSAGE-----
